...
module = [
    {
        ...
        onPacket: function (e) {
            if (mc.thePlayer) {
                ...
                } else if (e.getPacket() instanceof C03PacketPlayer) onGround = e.getPacket().onGround;
            }
        },
...
var targetModule, chestBlacklist = [], openInventory = false, lookingAtChest, lastChest, receivedItems, throwingPotion, userWhitelist, userBlacklist, isEating = -1, stacks, sortValues, sortTargets, onGround = false,
