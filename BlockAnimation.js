...
module = {
    ...
    values: list,
    onMotion: function () {
        mc.thePlayer.itemInUseCount = fake.get() && !KillAura.getValue("AutoBlock").get() && KillAuraClass.target && !!(heldItem = mc.thePlayer.getHeldItem()) && heldItem.getItem() instanceof Java.type("net.minecraft.item.ItemSword") ? 1337 : mc.thePlayer.itemInUseCount >= 1337 ? 0 : mc.thePlayer.itemInUseCount;
